...
const EditWorkoutDialog = ({ isOpen, onClose, onSave, workout, currentDay, weeklyPlanId }) => {
    ...
    useEffect(() => {
        if (workout) {
            ...
            setReps(workout.reps ? workout.reps.toString() : '');
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-6 p-3 bg-purple-50 rounded-lg">
                        <p className="text-sm text-purple-600 font-semibold">
                            Editing workout for: <span className="text-purple-800">{days[currentDay]}</span>
                        </p>
                    </div>
                    ...
                    <div className="flex space-x-3">
                        ...
                        <button
                            type="submit"
                            disabled={saving}
                            className="flex-1 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-semibold disabled:opacity-50 flex items-center justify-center space-x-2"
                        >
                            {saving ? (
                                <>
